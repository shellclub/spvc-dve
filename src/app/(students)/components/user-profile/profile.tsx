...
export default function EditProfilePage() {
  ...
  const swrKeyStd = session?.user.id ? `/api/users/${session.user.id}` : null;
  const { data, isLoading, error, mutate } = useSWR(swrKeyStd, fetcher);
  ...
  const sortedDays = Array.isArray(selectedDays) ? [...selectedDays].sort(
        ...
        <div className="space-y-4 sm:space-y-6">
                        ...
                        <>
                          ...
                          <div className="mb-3">
                            ...
                            <TextInput
                              ...
                              id="major"
                              defaultValue={data?.student?.major?.major_name || ''}
                            />
                          </div>
                          <div className="mb-3">
                            <Label>กลุ่ม</Label>
          ...
          <div className="border border-lg rounded-2xl p-4 sm:p-6 shadow">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 text-sm sm:text-base">
              ...
              <Field label="แผนกวิชา" value={data?.student?.department?.depname || '-'} />
              <Field label="สาขาวิชา" value={data?.student?.major?.major_name || '-'} />
